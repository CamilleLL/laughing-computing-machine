...
public class ConnectorSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ConnectorPackage.ROLE_PROVIDED: {
			RoleProvided roleProvided = (RoleProvided) theEObject;
			T result = caseRoleProvided(roleProvided);
			if (result == null)
				result = caseRole(roleProvided);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ConnectorPackage.ROLE_REQUIRED: {
			RoleRequired roleRequired = (RoleRequired) theEObject;
			T result = caseRoleRequired(roleRequired);
			if (result == null)
				result = caseRole(roleRequired);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Role Provided</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Role Provided</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRoleProvided(RoleProvided object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Role Required</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Role Required</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRoleRequired(RoleRequired object) {
		return null;
	}
