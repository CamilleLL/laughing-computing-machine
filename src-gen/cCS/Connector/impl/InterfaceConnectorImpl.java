 ...
 * </p>
 * <ul>
 *   <li>{@link cCS.Connector.impl.InterfaceConnectorImpl#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceConnectorImpl extends MinimalEObjectImpl.Container implements InterfaceConnector {
	...
	protected EClass eStaticClass() {
		return ConnectorPackage.Literals.INTERFACE_CONNECTOR;
	}
	...
	public EList<Role> getRole() {
		if (role == null) {
			role = new EObjectContainmentEList<Role>(Role.class, this, ConnectorPackage.INTERFACE_CONNECTOR__ROLE);
		}
		return role;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ConnectorPackage.INTERFACE_CONNECTOR__ROLE:
